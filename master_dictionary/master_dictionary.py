...
def load_masterdictionary(file_path, print_flag=False, f_log=None, get_other=False)->dict[str,'MasterDictionary']:
...
class MasterDictionary:
    def __init__(self, cols, _stopwords):
        ...
        try:
            ...
            quit()
        return
class ToneNertral(MasterDictionary):
    def __init__(self): 
        self.positive=0
        self.negative=0
        self.strong_modal=0
